...
exports.bytes = memoize((data) => {
    return new Value(data);
});
exports.number = memoize((num) => {
    return exports.bytes(typedArrayUtils_1.numberToByteArray(num));
});
exports.float = memoize((num) => exports.bytes(typedArrayUtils_1.float32bit(num)));
exports.vintEncodedNumber = memoize((num) => {
    return exports.bytes(exports.vintEncode(typedArrayUtils_1.numberToByteArray(num, exports.getEBMLByteLength(num))));
});
exports.string = memoize((str) => {

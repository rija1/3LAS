...
exports.bytes = (0, memoize_1.default)((data) => {
    return new Value(data);
});
exports.number = (0, memoize_1.default)((num) => {
    return (0, exports.bytes)((0, typedArrayUtils_1.numberToByteArray)(num));
});
exports.float = (0, memoize_1.default)((num) => (0, exports.bytes)((0, typedArrayUtils_1.float32bit)(num)));
exports.vintEncodedNumber = (0, memoize_1.default)((num) => {
    return (0, exports.bytes)((0, exports.vintEncode)((0, typedArrayUtils_1.numberToByteArray)(num, (0, exports.getEBMLByteLength)(num))));
});
exports.string = (0, memoize_1.default)((str) => {
